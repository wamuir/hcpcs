...
<section>
	...
	<div class="features">
		<article>
			...
			<div class="content">
				<h3>About HCPCS</h3>
				<p>Background information on the Health Care Procedure Coding System.</p>
			</div>
		</article>
		<article>
			...
			<div class="content">
				<h3>How to Use</h3>
				<p>Guidance on how to utilize HCPCS codes in government acquisition of medical supplies and equipment.</p>
			</div>
		</article>
		<article>
			...
			<div class="content">
				...
				<p>Coming very soon! Full text search for HCPCS codes.</p>
			</div>
		</article>
		<article>
			...
			<div class="content">
				...
				<p>A single-page listing of all HCPCS codes.</p>
			</div>
		</article>
		<article>
			...
			<div class="content">
				...
				<p>Browse and locate HCPCS codes by code group.</p>
			</div>
		</article>
		<article>
			...
			<div class="content">
				<h3>Keyword Index</h3>
				<p>Coming very soon! A keyword index for people who like indices.</p>
			</div>
		</article>
	</div>
</section>
...
<!-- Section -->
<section>
	<header id="codes-by-group" class="major">
		<h2>Codes by Group</h2>
	</header>
	<div class="posts">
		<article>
			<a href="groups/a.html" class="image"><img src="assets/images/camilo-jimenez-vGu08RYjO-s-unsplash.jpg" alt="" /></a>
			<h3>A0000&ndash;A9999<br> Transportation Services, Including Ambulance Medical and Surgical Supplies</h3>
	<!--		<p>Aenean ornare velit lacus, ac varius enim lorem ullamcorper dolore. Proin aliquam facilisis ante interdum. Sed nulla amet lorem feugiat tempus aliquam.</p> -->
			<ul class="actions">
				<li style="margin-top:40px;"><a href="groups/a.html" class="button" style="position:absolute;bottom:0;">A Codes</a></li>
			</ul>
		</article>
		<article>
			<a href="groups/b.html" class="image"><img src="assets/images/pawel-czerwinski-Q5oCIFL2xKc-unsplash.jpg" alt="" /></a>
			<h3>B4000&ndash;B9999<br> Enteral and Perenteral Therapy</h3>
	<!--		<p>Aenean ornare velit lacus, ac varius enim lorem ullamcorper dolore. Proin aliquam facilisis ante interdum. Sed nulla amet lorem feugiat tempus aliquam.</p> -->
			<ul class="actions">
	...
	<!--		<p>Aenean ornare velit lacus, ac varius enim lorem ullamcorper dolore. Proin aliquam facilisis ante interdum. Sed nulla amet lorem feugiat tempus aliquam.</p> -->
			<ul class="actions">
				<li style="margin-top:40px;"><a href="groups/g.html" class="button" style="position:absolute;bottom:0;">G Codes</a></li>
			</ul>
		</article>
		<article>
	...
	<!--		<p>Aenean ornare velit lacus, ac varius enim lorem ullamcorper dolore. Proin aliquam facilisis ante interdum. Sed nulla amet lorem feugiat tempus aliquam.</p> -->
			<ul class="actions">
				<li style="margin-top:40px;"><a href="groups/j.html" class="button" style="position:absolute;bottom:0;">J Codes</a></li>
			</ul>
		</article>
		<article>
	...
	<!--		<p>Aenean ornare velit lacus, ac varius enim lorem ullamcorper dolore. Proin aliquam facilisis ante interdum. Sed nulla amet lorem feugiat tempus aliquam.</p> -->
			<ul class="actions">
				<li style="margin-top:40px;"><a href="groups/l.html" class="button" style="position:absolute;bottom:0;">L Codes</a></li>
			</ul>
		</article>
		<article>
	...
	<!--		<p>Aenean ornare velit lacus, ac varius enim lorem ullamcorper dolore. Proin aliquam facilisis ante interdum. Sed nulla amet lorem feugiat tempus aliquam.</p> -->
			<ul class="actions">
				<li style="margin-top:40px;"><a href="groups/p.html" class="button" style="position:absolute;bottom:0;">P Codes</a></li>
			</ul>
		</article>
		<article>
	...
	<!--		<p>Aenean ornare velit lacus, ac varius enim lorem ullamcorper dolore. Proin aliquam facilisis ante interdum. Sed nulla amet lorem feugiat tempus aliquam.</p> -->
			<ul class="actions">
				<li style="margin-top:40px;"><a href="groups/r.html" class="button" style="position:absolute;bottom:0;">R Codes</a></li>
			</ul>
		</article>
		<article>
